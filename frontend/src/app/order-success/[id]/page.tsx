...
export default function OrderSuccessPage() {
  ...
  const orderId = (params?.id as string) || 'ord-jpl-889900';
      ...
      <div className="bg-white p-8 sm:p-10 rounded-lg border-2 border-[#D4AF37] shadow-luxury flex flex-col sm:flex-row items-center gap-6 relative overflow-hidden">
        ...
        <div className="space-y-2 flex-1">
          ...
          <p className="text-xs sm:text-sm text-[#666] leading-relaxed">
            Order Reference ID: <strong className="text-[#6B1D2F] font-mono font-bold">{orderId}</strong> | A confirmation notification and tracking SMS have been sent to your registered mobile and email.
          </p>
        </div>
      </div>
